...
public class RechercheMotif {
    ...
    public static long duree(String txt, String motif) {
        // rechauffer la JVM pour reduire bias
        for (int i = 0; i < 5; i++) {
            KMPalgo(txt, motif);
        }
    ...
    public static void chercherPlusieursMotifs(String txt, List<String> motifs, String outputFile) throws IOException {
        ...
        writer.append("Motif,Temps d'exécution (millisecondes),Nombre d'occurrences\n");
        ...
        for (String motif : motifs) {
            ...
            System.out.println("Temps d'exécution de KMP : " + execTime + " millisecondes");
